...
| # | Decisión | Estado |
|---|-----------|---------|
| [ADR-008](../02-DECISIONES/008-postgresql-schema-separation.md) | PostgreSQL Schema Separation | **Current** |
| [ADR-009](../02-DECISIONES/009-vista-postgresql-para-tramites.md) | Vista PostgreSQL Unificada | **Current** |
| [ADR-010](../02-DECISIONES/010-integracion-con-sftp.md) | Integración SFTP | **Current** |
| [ADR-012](../02-DECISIONES/012-stack-base-actualizado.md) | Stack Actualizado | **Current** |
| [ADR-014](../02-DECISIONES/014-custom-user-workflow-permissions.md) | Custom User + Workflow Permissions | **Current** |
...
- **Separación de esquemas**: [ADR-008: PostgreSQL Schema Separation](../02-DECISIONES/008-postgresql-schema-separation.md)
- **Vista v_tramites_unificado**: [ADR-009: Vista PostgreSQL Unificada](../02-DECISIONES/009-vista-postgresql-para-tramites.md)
- **Integración SFTP**: [ADR-010: Integración con SFTP](../02-DECISIONES/010-integracion-con-sftp.md)
- **Estrategia de caching**: [ADR-003: Estrategia de Caching](../02-DECISIONES/003-estrategia-caching-rendimiento.md)
- **Custom User + Workflow Permissions**: [ADR-014: Custom User + Workflow Permissions](../02-DECISIONES/014-custom-user-workflow-permissions.md)
- **Stack tecnológico**: [ADR-012: Stack Base Actualizado](../02-DECISIONES/012-stack-base-actualizado.md)
