...
Ver: [Referencia de estados](../05-DEVELOPERS/workflow.md)
...
Ver: [ADR-008: Schema Separation](../02-DECISIONES/008-postgresql-schema-separation.md)
...
Ver: [ADR-009: Vista Unificada](../02-DECISIONES/009-vista-postgresql-para-tramites.md)
...
Ver: [Referencia RBAC](../05-DEVELOPERS/rbac.md)
...
- [Overview del sistema](README.md)
- [Arquitectura detallada](01-ARQUITECTURA.md)
- [Referencia de estados de trámites](../05-DEVELOPERS/workflow.md)
- [Glosario de comandos Django](../05-DEVELOPERS/commands.md)
