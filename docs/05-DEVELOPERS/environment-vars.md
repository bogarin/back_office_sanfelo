...
Ver [ADR-008: PostgreSQL Schema Separation](../02-DECISIONES/008-postgresql-schema-separation.md).
...
- **Ver guía:** [Guía de configuración SFTP](./sftp-setup.md)
