...
- [Arquitectura del sistema](../01-ARQUITECTURA/01-ARQUITECTURA.md) — Entender cómo funciona
- [Glosario](../01-ARQUITECTURA/glosario.md) — Términos del dominio
- [Referencia RBAC](./rbac.md) — Sistema de roles
