...
| `docs/02-DECISIONES/008-postgresql-schema-separation.md` | Eliminadas menciones al schema validator (sección, referencia en risks, paso de migración, link) |
| `docs/02-DECISIONES/002-configuracion-multiples-bases-de-datos.md` | Agregada nota en "Superseded by" referenciando este ADR |
