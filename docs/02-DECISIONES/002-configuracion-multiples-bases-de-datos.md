...
**Estado:** Superseded
**Superseded by:** [ADR-008: PostgreSQL Schema Separation for Multi-Database Architecture](008-postgresql-schema-separation.md)
...
[ADR-008: PostgreSQL Schema Separation for Multi-Database Architecture](008-postgresql-schema-separation.md)
