...
│
├── 01-onboarding/          # 🚀 Para nuevos miembros
...
│   ├── api/               # API endpoints, auth, errors
│   ├── models/            # Data models, SQL schema
│   ├── commands/          # Django commands
│   ├── configuration/    # Environment vars, settings
│   └── components/        # Admin, validator, cache
│
...
**¿Para quién?**: Principiantes y nuevos miembros
**Ejemplos**:
...
| Tipo / Rol | Operador | Administrador | Desarrollador | Sysadmin | AI Agent |
|------------|----------|---------------|---------------|----------|----------|
| **Tutorials** | ✅ | ✅ | ✅ | ❌ | ❌ |
| **Guides** | ✅ | ✅ | ✅ | ✅ | ❌ |
| **Concepts** | ❌ | ❌ | ✅ | ✅ | ✅ |
...
- [Django Documentation oficial](https://docs.djangoproject.com/)
...
### Para Arquitectura
- [ADR Template](06-decisions/template.md)
- [Diátaxis Framework](https://diataxis.fr/) - Metodología de documentación
...
1. **Identifica el tipo**: Tutorial, Guide, Concept, o Reference
2. **Usa el template apropiado**: Ver templates en [`RESTRUCTURING_PLAN.md`](../RESTRUCTURING_PLAN.md)
...
- ✅ **User-centered**: Pensar en la audiencia objetivo
- ✅ **Andragogy**: Relevante, práctico, inmediato
...
- [ADRs](06-decisions/README.md) - Decisiones de arquitectura
