...
class CatTramiteAdmin(AuditTrailMixin, CatalogBaseAdmin):
...
class CatEstatusAdmin(AuditTrailMixin, CatalogBaseAdmin):
...
class CatUsuarioAdmin(AuditTrailMixin, BaseModelAdmin):
...
class CatActividadAdmin(AuditTrailMixin, CatalogBaseAdmin):
...
class CatCategoriaAdmin(AuditTrailMixin, CatalogBaseAdmin):
...
class CatIncisoAdmin(AuditTrailMixin, BaseModelAdmin):
...
class CatRequisitoAdmin(AuditTrailMixin, CatalogBaseAdmin):
...
class CatTipoAdmin(AuditTrailMixin, CatalogBaseAdmin):
...
class RelTmtCateReqAdmin(AuditTrailMixin, BaseModelAdmin):
...
class RelTmtCategoriaAdmin(AuditTrailMixin, BaseModelAdmin):
...
class RelTmtIncisoAdmin(AuditTrailMixin, BaseModelAdmin):
...
class RelTmtTipoReqAdmin(AuditTrailMixin, BaseModelAdmin):
...
class RelTmtActividadAdmin(AuditTrailMixin, BaseModelAdmin):
...
class ActividadesAdmin(AuditTrailMixin, BaseModelAdmin):
...
class CobroAdmin(AuditTrailMixin, BaseModelAdmin):
