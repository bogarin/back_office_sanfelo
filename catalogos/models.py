...
class CatTramite(models.Model):
    ...
    respuesta_dias = models.FloatField(default=0, verbose_name="Respuesta en Días")
    pago_inicial = models.BooleanField(default=True, verbose_name="Pago Inicial")
...
class CatEstatus(models.Model):
    ...
    responsable = models.CharField(
        max_length=64, blank=True, null=True, verbose_name="Responsable"
    )
    descripcion = models.CharField(
...
class CatUsuario(models.Model):
    ...
    correo = models.CharField(
        max_length=255, blank=True, null=True, verbose_name="Correo"
    )
...
class CatPerito(models.Model):
    ...
    nombre = models.CharField(
        max_length=90, blank=True, null=True, verbose_name="Nombre"
    )
    domicilio = models.CharField(
        max_length=250, blank=True, null=True, verbose_name="Domicilio"
    )
    colonia = models.CharField(
        max_length=120, blank=True, null=True, verbose_name="Colonia"
    )
    telefono = models.CharField(
        max_length=16, blank=True, null=True, verbose_name="Teléfono"
    )
    celular = models.CharField(
        max_length=16, blank=True, null=True, verbose_name="Celular"
    )
    correo = models.CharField(
        max_length=255, blank=True, null=True, verbose_name="Correo"
    )
    ...
    cedula = models.CharField(
        max_length=19, blank=True, null=True, verbose_name="Cédula"
    )
...
class CatCategoria(models.Model):
    ...
    categoria = models.CharField(
        max_length=120, blank=True, null=True, verbose_name="Categoría"
    )
...
class RelTmtCateReq(models.Model):
    ...
    id_cat_categoria = models.IntegerField(
        blank=True, null=True, verbose_name="ID Categoría"
    )
...
class RelTmtTipoReq(models.Model):
    ...
    def __str__(self) -> str:
        return (
            f"Tipo {self.id_cat_tipo} - Trámite {self.id_cat_tramite} "
            f"- Req {self.id_cat_requisito}"
        )
